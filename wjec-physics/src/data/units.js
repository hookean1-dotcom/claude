...
const UNITS = [
  ...
  { id: '3', code: 'Unit 3', name: 'Oscillations and Nuclei', level: 'A2', nm: 546.1, line: 'Hg 546.1 nm', css: 'var(--u3)', exam: 'Written exam · 2 h 15 min · 100 marks · 25% of A level' },
  { id: '4', code: 'Unit 4', name: 'Fields and Options', level: 'A2', nm: 486.1, line: 'H-β 486.1 nm', css: 'var(--u4)', exam: 'Written exam · 2 h · 100 marks · 25% of A level (Section A core, Section B one option)' },
  ...
  { id: 'S', code: 'Skills', name: 'Maths, data & practical skills', level: 'AS + A2', nm: 404.7, line: 'Hg 404.7 nm', css: 'var(--u6)', exam: 'Assessed in every written paper and in the Unit 5 practical examination (10% of A level)' }
];
const TOPICS = [];
